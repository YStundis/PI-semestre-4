      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-4">
            ...
            <h2 class="heading text-primary">Apartamento, Residencial, Santa Cecilia, 5 vaga(s) de garagem</h2>
            <p class="meta">Rua Tupi, n° 275, Apt Duplex 251, Edifício Maison Nathalie, Santa Cecilia, São Paulo/SP, CEP: 04477-420</p>
            <p class="text-black-50">
            Apartamento, Santa Cecilia, Desocupado, contendo 4 suíte(s), 5 vaga(s) de garagem, 6 banheiro(s), 572.00 M² de área de terreno, 349.00 M² de área construída, 349.00 M² de área útil, 572.00 M² de área total. Matrícula nº 111263. IPTU anual R$ 28.000,00, valor de condomínio mensal R$ 5.900,00.
            </p>
            ...
            <div class="d-flex d-inline-flex d-block agent-box col-12">
              <div class="d-flex justify-content-center col-6 pt-3">
                <h5 style="color: green">R$ 4.000.000</h5>
              </div>
