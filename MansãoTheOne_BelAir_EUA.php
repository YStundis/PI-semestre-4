      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-4">
            ...
            <h2 class="heading text-primary">Mansão, Residencial, Bel Air, 30 vaga(s) de garagem</h2>
            <p class="meta">Bel Air, Califórnia</p>
            <p class="text-black-50">
            Em português, The One pode ser traduzido como A Única! Sim, a casa mais cara do mundo é sem sombra de dúvidas uma singular extravagância arquitetônica e vai entrar no mercado pela bagatela de meio bilhão de dólares. A mega mansão, como está sendo descrita, conta com 20 quartos, 30 banheiros, espaço para comportar 30 carros, 5 piscinas, um cinema para 36 pessoas, 6 pistas de boliche e até mesmo uma boate dentro da casa. Ficou interessado? Quem representa a propriedade é a companhia The Society Group. É só dar uma ligadinha.
            </p>
            ...
            <div class="d-flex d-inline-flex d-block agent-box col-12">
              <div class="d-flex justify-content-center col-6 pt-3">
                <h5 style="color: green">R$ 500.000.000</h5>
              </div>
