      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-7">
            <div class="img-property-slide-wrap">
              <div class="img-property-slide">
                <img src="images\camara_municipal_barretos_1.jpg" alt="Image" class="img-fluid" />
                <img src="images\camara_municipal_barretos_2.jpg" /> 
                <img src="images\camara_municipal_barretos_3.jpg" />
              </div>
            </div>
          </div>
          <!-- Fim do Carousel -->
          <div class="col-lg-4">
            ...
            <h2 class="heading text-primary">Camara Municipal Barretos, garagem para 6 carros</h2>
            ...
            <div class="d-flex d-inline-flex d-block agent-box col-12">
              <div class="d-flex justify-content-center col-6 pt-3">
                <h5 style="color: green">R$ 10,00</h5>
              </div>
