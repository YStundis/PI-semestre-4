      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-4">
            ...
            <h2 class="heading text-primary">Mansão, Residencial, Bel Air, Possui Garagem para 2 carros.</h2>
            <p class="meta">Bel Air, Califórnia</p>
            <p class="text-black-50">
            Quem já assistiu Um Maluco no Pedaço, sabe que Will Smith se muda para um dos bairros mais luxuosos da Califórnia, Bel Air. Localizada nesta magnífica parte do estado, a Casa Encantada não tem este nome à toa. Construída nos anos de 1930, ela possui um formato em H que dá vista para a cidade, o oceano e os jardins pelos 60 quartos distribuídos na propriedade.
            </p>
            ...
            <div class="d-flex d-inline-flex d-block agent-box col-12">
              <div class="d-flex justify-content-center col-6 pt-3">
                <h5 style="color: green">R$ 225.000.000</h5>
              </div>
