      ...
      <div class="container">
        <div class="row justify-content-between">
          ...
          <div class="col-lg-4">
            ...
            <h2 class="heading text-primary">Rancho do Peão, garagem para 15000 carros</h2>
            <p class="meta">Barretos, São Paulo</p>
            <p class="text-black-50">
            Quatro palcos, 300 lojas e restaurantes, estacionamento para 15 mil veículos, área de camping para 15 mil pessoas e estádio com capacidade para 35 mil fãs sentados. Tudo isso em uma área de 2 milhões de metros quadrados. O Parque do Peão tem o dobro de tamanho do Autódromo de Interlagos, onde acontece o Lollapalooza
            </p>
            ...
            <div class="d-flex d-inline-flex d-block agent-box col-12">
              <div class="d-flex justify-content-center col-6 pt-3">
                <h5 style="color: green">R$ 800.000.000</h5>
              </div>
